...
POSTGRES_COMPATIBILITY_PATCH_STATEMENTS: tuple[str, ...] = (
    ...
    "ALTER TABLE IF EXISTS rounds ADD COLUMN IF NOT EXISTS missing_score_pct DOUBLE PRECISION",
    "UPDATE rounds SET missing_score_pct = 0.0 WHERE missing_score_pct IS NULL AND missing_homework_policy IN ('zero', 'penalty')",
